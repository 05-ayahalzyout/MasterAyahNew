<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Masterpiece.login1" %>
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5"  style="color:#2B3467;font-family:Caveat Regular;">login</h2>
             ...
             <input type="email" id="form3Example3" class="form-control" style="border:4px solid #5E5656"/>
              ...
              <div class="text-center">
                <p style="color:#2B3467;font-family:Caveat Regular;">don't have an account? <a href="Registration.aspx" class="text-muted"> <br />
                    <u> sign up</u></a></p>
              </div>
            </form>
          </div>
